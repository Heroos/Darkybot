...
let owner = client.users.get("191272823170269184").tag
  ...
  .addField(":soccer: Fun: ", "`8ball`, `sayd`, `avatar`, `doggo`, `cat`, `birdy`, `fishy`, `pof`, `rps`, `memes`, `rtd`, `emojifier`, `mc`, `trigger`, `google`")
  ...
  .addField("<:staff:314068430787706880> Administration: ", "`report`, `ban`, `kick`, `giverole`, `removerole`, `mute`")
  .addField(":musical_note: Musique: [ALPHA]", "`play`, `skip`, `leave`, `pause`, `resume`")
  .addField(":busts_in_silhouette: Utilisateur: ", "`ui`, `level`, `coins`, `pay`, `daily`, `top`")
  .addField(":file_folder: Autre:", "`ping`, `is`, `clear`, `social`, `help`")
